...
export const TrialBanner: React.FC<TrialBannerProps> = ({ onUpgradeClick, compact = false }) => {
  ...
  return (
    <div className={`border-b px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between gap-2 sm:gap-3 text-xs transition-colors ${
      isUrgent 
      ...
      <div className="hidden lg:flex items-center gap-2.5 text-[11px] font-mono text-white/50 w-48 shrink-0">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        <button
          onClick={handleUpgrade}
          className="px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-gradient-to-r from-[#FFD700] to-amber-400 text-black font-extrabold hover:brightness-110 transition-all flex items-center gap-1 sm:gap-1.5 shadow-[0_0_12px_rgba(255,215,0,0.2)] cursor-pointer text-[11px] sm:text-xs whitespace-nowrap active:scale-95"
        >
